...
@section('content')
<div class="py-5">
    {{ Breadcrumbs::render('admin.billboard.edit', $billboard->id) }}
</div>
<div class="p-4 px-4 md:p-8 mb-6">
    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
        ...
        <div class="lg:col-span-2">
            ...
            <form action="{{ $billboard->id }}/update" method="post" enctype="multipart/form-data"
                class="lg:col-span-2">
                @csrf
                @method('PUT')
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                    <div class="md:col-span-5">
                        ...
                        <input type="text" name="label" id="label"
                            ...
                            placeholder="Write the label here..." value="{{ $billboard->label }}" />
                    </div>
                    <div class="md:col-span-5">
