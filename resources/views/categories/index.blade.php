    ...
    <div class="grid grid-flow-col gap-5">
        <a href="/admin/category"
            ...
            <div class="flex gap-5">
                <div class="w-[4.5rem] h-[4.5rem] bg-blue-200 rounded-full flex items-center justify-center">
                    @svg('tabler-category', 'w-8 h-8 text-blue-600')
                </div>
        ...
        <a href="/admin/category"
            ...
            <div class="flex gap-5">
                ...
                <div class="flex flex-col">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">{{ $bestCategory->name
                        ?? 'Belum ada'}}
                    </h5>
                    <p class="font-normal text-gray-700 ">best categories</p>
                </div>
            </div>
        </a>
        ...
        <form action="" method="get">
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search"
                    ...
                    placeholder="Search name, created by..." required name="search">
                <button type="submit"
            ...
            <tbody>
                ...
                <tr class="bg-white border-bhover:bg-gray-50 text-zinc-900">
                    ...
                    <td class="px-6 py-4 text-right flex gap-4">
                        ...
                        <form action="category/delete/{{$data->id}}" method="POST" class="inline">
                            @csrf
                            @method('delete')
                            <button type="submit" class="font-medium text-red-600 hover:underline"
                                onclick="return confirm('Are you sure?') ? window.location.href='category/delete/{{$data->id}}' : false">Delete</button>
                        </form>
                    </td>
                </tr>
                @endforeach
