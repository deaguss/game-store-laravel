...
@section('content')
<div class="py-5">
    {{ Breadcrumbs::render('admin.game.edit', $games->id) }}
</div>
<div class="p-4 px-4 md:p-8 mb-6">
    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
        <div class="text-gray-600">
            <p class="font-medium text-lg">Game Details</p>
        ...
        <div class="lg:col-span-2">
            ...
            <form action="{{ $games->id }}/update" method="post" enctype="multipart/form-data" class="lg:col-span-2">
                @csrf
                @method('PUT')
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                    <div class="md:col-span-5">
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="Write the title here..." value="{{ $games->title }}" />
                    </div>
                    <div class="md:col-span-5">
                        <label for="developer" class="block mb-2 text-sm font-medium text-gray-900">Developer</label>
                        <input type="text" name="developer" id="developer"
                            class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="@unicorn"
                            value="{{ $games->developer }}" />
                    </div>
                    <div class="md:col-span-5">
                        <label for="price" class="block mb-2 text-sm font-medium text-gray-900">Price</label>
                        <input type="number" name="price" id="price"
                            class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="$1.00"
                            value="{{ $games->price }}" />
                    </div>
                    <div class="md:col-span-5">
                    ...
                    <div class="md:col-span-5">
                        <label for="release_date" class="block text-sm font-medium text-gray-700">Release games</label>
                    ...
                    <div class="md:col-span-5">
                        ...
                        <textarea id="description" rows="4"
                            ...
                            name="description">{{ $games->description}}</textarea>
                    </div>
                    <div class="md:col-span-5 mt-5">
                        <label for="" class="block mb-2 text-sm font-medium text-gray-900">Upload image game</label>
